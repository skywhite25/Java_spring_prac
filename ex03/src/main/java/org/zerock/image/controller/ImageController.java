...
//	public String rankList(Model model, @ModelAttribute PageObject pageObject, ImageVO vo, HttpSession session) throws Exception {
//		log.info("rankList().pageObject : " + pageObject + "---------------------" 
//				+ "rankList().vo : " + vo + "---------------------");
//		
//		model.addAttribute("list", service.rankList(pageObject, vo));
//		
