...
public class PageObject {
	...
	public static PageObject getInstance(HttpServletRequest request) throws Exception {
		...
		pageObject.setStartDay(request.getParameter("startDay"));
		pageObject.setEndDay(request.getParameter("endDay"));
		pageObject.setLev(request.getParameter("lev"));
	...
	public String toString() {
		return "PageObject [page=" + page + ", perPageNum=" + perPageNum + ", startRow=" + startRow + ", endRow="
				...
				+ ", period=" + period + ", accepter=" + accepter + ", acceptMode=" + acceptMode + ", startDay=" + startDay + ", endDay=" + endDay + ", lev=" + lev+ "]";
	}
